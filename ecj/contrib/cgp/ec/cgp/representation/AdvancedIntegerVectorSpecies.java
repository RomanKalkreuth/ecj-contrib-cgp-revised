...
public class AdvancedIntegerVectorSpecies extends IntegerVectorSpecies {
	...
	public void setup(EvolutionState state, Parameter base) {
		...
		connectNeighbourNode = state.parameters.getBoolean(base.push(P_CONNECT_NEIGHBOUR_NODE ), def
        ...
        connectNeighbourNode =state.parameters.getBoolean(base.push(P_CNN),def.push(P_CNN), false);
